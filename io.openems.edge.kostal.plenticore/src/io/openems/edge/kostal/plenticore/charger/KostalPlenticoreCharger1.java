...
@Component(//
		name = "Kostal.Plenticore.Charger1", //
		immediate = true, //
...
public class KostalPlenticoreCharger1 extends AbstractKostalPlenticoreCharger
	...
	public KostalPlenticoreCharger1() throws OpenemsException {
	}
	...
	@Override
	protected KostalPlenticore getEss() {
		return this.ess;
	}
}
